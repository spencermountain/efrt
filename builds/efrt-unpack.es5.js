...
module.exports = function (str) {
  ...
  let all = {};
  Object.keys(obj).forEach(function (cat) {
    let arr = unpack(obj[cat]); //special case, for botched-boolean
...
const encoding = _dereq_('../encoding'); //the symbols are at the top of the array.
...
const encoding = _dereq_('../encoding'); // References are either absolute (symbol) or relative (1 - based)
...
const toArray = function (trie) {
  ...
  const crawl = (index, pref) => {
    ...
    for (let i = 0; i < matches.length; i += 2) {
      ...
      let have = pref + str; //branch's end
...
module.exports = function (str) {
  ...
  var all = {};
  Object.keys(obj).forEach(function (cat) {
    var arr = unpack(obj[cat]); //special case, for botched-boolean
...
var encoding = _dereq_('../encoding'); //the symbols are at the top of the array.
...
var encoding = _dereq_('../encoding'); // References are either absolute (symbol) or relative (1 - based)
...
var unpack = function unpack(str) {
  var trie = {
    ...
    //that's all ;)!
    syms: [],
    symCount: 0 //process symbols, if they have them
